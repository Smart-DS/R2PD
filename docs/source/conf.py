...
project = 'Renewable Resource and Power Data tool (R2PD)'
copyright = '2017, Michael Rossol, Elaine Hale'
...
man_pages = [
    (master_doc, 'R2PD', 'R2PD Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'R2PD', 'R2PD Documentation',
     author, 'R2PD', 'One line description of project.',
     'Miscellaneous'),
]
